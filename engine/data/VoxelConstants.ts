...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
  ...
  [BuildingType.STORAGE_EXTENSION]: {
    ...
    cost: 300,
    desc: 'Expands adjacent storage capacity by 250 units.',
    ecoReq: 0,
    stats: '+250 Storage',
    width: 2,
    depth: 1,
    buildTime: 15,
    dependency: BuildingType.STORAGE_DEPOT, // Logical dependency, placement logic handled in check
    maintenance: 0.5,
    pollution: 0.1,
    era: Era.SETTLEMENT
  },
  [BuildingType.STOCKPILE]: {
    ...
    cost: 3500,
    desc: 'A massive open-air storage facility. Increases total resource capacity by 2000.',
    ecoReq: 0,
    stats: '+2000 Capacity',
    width: 3,
    depth: 3,
